...
<link href="../../StyleSheet/User/Cart.css" rel="stylesheet" type="text/css" />
<div id="WrapCart">
    <asp:MultiView ID="MultiView1" runat="server">
        ...
        <div style="overflow: auto;height: 100px;">
            ...
            <div style="text-align: right">
                <asp:LinkButton ID="LinkButtonSubmitCart" runat="server" OnClick="LinkButtonSubmitCart_Click">
                    <asp:Image ToolTip="Submit" ID="Image2" ImageUrl="~/Resource/icon/checkbox_checked.png"
